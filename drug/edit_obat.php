...
if ($_SERVER['REQUEST_METHOD'] === 'GET' && isset($_GET['id'])) {
    ...
    $query = "UPDATE obat SET nama='$nama', keterangan='$keterangan', stok='$stok' WHERE idObat='$idObat'";
    $result = mysqli_query($connection, $query);
    ...
    <div class="container">
        ...
        <form method="POST" action="edit_obat.php">
            ...
            <div class="form-group">
                ...
                <textarea name="keterangan" class="form-control"><?php echo $obat['keterangan']; ?></textarea>
            </div>
            <div class="form-group">
