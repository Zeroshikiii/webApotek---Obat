...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['tambah_obat'])) {
        ...
        $query = "INSERT INTO obat (nama, keterangan, stok) VALUES ('$nama', '$keterangan', '$stok')";
    ...
    if (isset($_POST['edit_obat'])) {
        ...
        $query = "UPDATE obat SET nama='$nama', keteranganerangan='$keterangan', stok='$stok' WHERE idObat='$idObat'";
        $result = mysqli_query($connection, $query);
